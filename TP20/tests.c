...
Command	: gcc -Wall -Wextra -Werror -Wpedantic -g -O0 tests.c tp21.c grandes_lettres.c -o tests
Date	: 17.03.2023
____________________
*/

// #files: tp21.c grandes_lettres.c
// #args: -O0
#include <assert.h>
#include <string.h>
#include <stdio.h>
...
int main(void)
{
  ...
  affichage(10, "Sit aliqua veniam incididunt et pariatur ut commodo occaecat do exercitation.");
  ascii_art("hi lol");
}
